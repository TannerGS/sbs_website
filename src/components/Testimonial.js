          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-28">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto mb-10">
                ...
                <p className="font-bold" >Jaeden Richards </p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco"
                </p>
                <p className="text-lg font-light leading-relaxed mt-8 mb-4 text-gray-700">
                <p className="font-bold" >Bayelei Doty </p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco"
                </p>
                <a
                  href="/contact"
